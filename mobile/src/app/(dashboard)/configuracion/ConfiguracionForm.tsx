...
export function ConfiguracionForm({ nombreNegocio, moneda, simboloMoneda, diasAlertaVencimiento, onExito }: Props) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        ...
        <input id="nombreNegocio" name="nombreNegocio" type="text" defaultValue={nombreNegocio} required className={clasesInput} />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input id="simboloMoneda" name="simboloMoneda" type="text" defaultValue={simboloMoneda} required className={clasesInput} />
        </div>
      </div>

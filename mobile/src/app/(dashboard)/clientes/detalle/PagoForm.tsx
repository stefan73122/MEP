...
export function PagoForm({ clienteId, onExito }: { clienteId: number; onExito: () => void }) {
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <p className="text-xs text-slate-500">El pago se aplica primero a la deuda más antigua del cliente.</p>
